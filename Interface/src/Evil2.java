...
public class Evil2 extends Player implements Runnable{
	...
	public Evil2(int lives, int xAxis, String imagePath, boolean isAlive, Level2 Level2, Player lorann) {
	...
	public void run() {
		while (true) {
		 ...
		 else if(getxAxis() >= (Level2.widthofscene - 30)) {
			 xdirection = -1;
		 ...
		 else if(getyAxis() >= (Level2.heightofscene - 30)) {
			 ydirection = -2;
