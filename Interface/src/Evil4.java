...
public class Evil4 extends Player implements Runnable{
	...
	public Evil4(int lives, int xAxis, String imagePath, boolean isAlive, Level4 Level4, Player lorann) {
	...
	public void run() {
		while (true) {
		 ...
		 else if(getxAxis() >= (Level4.widthofscene - 30)) {
			 xdirection = -1;
		 ...
		 else if(getyAxis() >= (Level4.heightofscene - 30)) {
			 ydirection = -2;
