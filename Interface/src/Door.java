...
public class Door extends Player implements Runnable{
	...
	public Door(int lives, int xAxis, int yAxis, String imagePath, boolean isAlive,Level1 Level1, Player lorann) {
