...
public class Crystal5 extends Player implements Runnable{
	...
	public Crystal5(int lives, int xAxis, int yAxis, String imagePath, boolean isAlive,Level5 Level5, Player lorann) {
