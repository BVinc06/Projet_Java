...
public class Door5 extends Player implements Runnable{
	...
	public Door5(int lives, int xAxis, int yAxis, String imagePath, boolean isAlive,Level5 Level5, Player lorann) {
