...
public class Evil5 extends Player implements Runnable{
	...
	public Evil5(int lives, int xAxis, String imagePath, boolean isAlive, Level5 Level5, Player lorann) {
	...
	public void run() {
		while (true) {
		 ...
		 else if(getxAxis() >= (Level5.widthofscene - 30)) {
			 xdirection = -1;
		 ...
		 else if(getyAxis() >= (Level5.heightofscene - 30)) {
			 ydirection = -2;
